...
public class appointments_activity extends Activity {
	...
	private View _bg__appointments_ek3;
	...
	private View navigation_bar_rect_ek1;
	private ImageView vector_ek124;
	private TextView appointments_ek4;
	private View _app_rect_ek1;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		_bg__appointments_ek3 = (View) findViewById(R.id._bg__appointments_ek3);
		...
		navigation_bar_rect_ek1 = (View) findViewById(R.id.navigation_bar_rect_ek1);
		vector_ek124 = (ImageView) findViewById(R.id.vector_ek124);
		appointments_ek4 = (TextView) findViewById(R.id.appointments_ek4);
		_app_rect_ek1 = (View) findViewById(R.id._app_rect_ek1);
		vector_ek125 = (ImageView) findViewById(R.id.vector_ek125);
		home_ek4 = (TextView) findViewById(R.id.home_ek4);
	
		
		_app_rect_ek1.setOnClickListener(new View.OnClickListener() {
