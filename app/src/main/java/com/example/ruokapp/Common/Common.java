...
public class Common {
    ...
    public static User cntUser;

    public static Object convertTimeSlotToString(int slot) {
        switch (slot) {
            case 0:
                return "04/18/2023 9:00-10:00";
            case 1:
                return "04/18/2023 10:00-11:00";
            case 2:
                return "04/20/2023 11:00-12:00";
            case 3:
                return "04/20/2023 12:00-1:00";
            case 4:
                return "04/22/2023 1:00-2:00";
            case 5:
                return "04/22/2023 2:00-3:00";
            case 6:
                return "04/24/2023 3:00-4:00";
            case 7:
                return "04/24/2023 4:00-5:00";
            default:
                return "Closed";
