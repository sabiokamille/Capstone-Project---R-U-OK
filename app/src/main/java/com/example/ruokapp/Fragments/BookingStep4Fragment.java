...
public class BookingStep4Fragment extends Fragment {
    ...
    void confirmBooking() {
        ...
        /**THIS MIGHT BE THE PROBLEM IF NOTHING SHOWS UP AND IT GETS CANCELED */
        bookingInformation.setUserName(Common.cntUser.getName());
        bookingInformation.setUserStudentID(Common.cntUser.getStudentID());
    ...
    private void setData() {
        ...
        txt_therapy_address.setText(Common.currentPreferences.getAddress());

        txt_therapy_number.setText(Common.currentPreferences.getPhone());
